'''
Credit to ARCTIC: https://github.com/zc-alexfan/arctic
'''
...
def compute_v2v_dist_no_reduce(v3d_cam_gt, v3d_cam_pred):
    dist = ((v3d_cam_gt - v3d_cam_pred) ** 2).sum(dim=1).sqrt().numpy()  # meter
