...
VIDEO_FILENAMES=(
    ...
    # P01_103_378_423_left_plate_1858.mp4
...
for VIDEO_FILE in "${VIDEO_FILENAMES[@]}"; do
    ...
    srun --gpus=1 python -u demo_run.py -d epic \
        ...
        -o /home/u5gi/jiahezhao25.u5gi/jiahe/data/epic-grasps/pico_v3/pico_stage3_772videos_wilorspace/2026-02-12_pico_stage3_772videos_wilorspace_maskv3_newsf_multiprior_[template]/ \
